...
+ Проблема слова в $G$ должна иметь быстрое (линейное или квадратичное) решение детерминированным алгоритмом. Более того, должна существовать эффективно вычислимая "нормальная форма" для элементов $G$.
